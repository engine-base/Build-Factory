...
| 二重実装解消 (ARCHIVE) | E-014 (tasks legacy), E-007 (ai_employee_config), E-027 (pull_requests), E-032 (repos) = 4 件 — **完了 2026-05-17 T-V3-D-04 / ADR-015 / migration 20260516140000 で `_archived_<name>` へ RENAME 済 (data 保全 + service_role-only RLS)** | task-decomposition Group D + migration ARCHIVE |
