import { isColorEmpty } from '@/lib/onlook/utility';
...
// TODO: Build-Factory integration - removed Onlook dependency (@/hooks/use-font-loader)
const ensureFontLoaded = (fontFamily: string): string => fontFamily;
