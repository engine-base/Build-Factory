...
import { DefaultSettings } from '@/lib/onlook/constants';
import type { Canvas, RectPosition } from '@/lib/onlook/models';
...
// TODO: Build-Factory integration - replace with backend default frame
const DefaultDesktopFrame = { width: 1440, height: 900 } as const;
