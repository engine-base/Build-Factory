...
// TODO: Build-Factory integration - removed Onlook dependency (@/trpc/react)
import { EditorMode } from '@/lib/onlook/models';

// Stub: replace with Build-Factory user settings provider
const api = {
    user: {
        settings: {
            get: {
                useQuery: (): { data: { chat: { showMiniChat: boolean } } } => ({
                    data: { chat: { showMiniChat: true } },
                }),
            },
        },
    },
