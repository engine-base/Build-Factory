import { useEditorEngine } from '@/components/design-canvas/store';
// TODO: Build-Factory integration - removed Onlook dependency (@/i18n/keys, next-intl)
import { ChatType } from '@/lib/onlook/models';
import { Button } from '@/lib/onlook/ui/button';
import { Icons } from '@/lib/onlook/ui/icons';
import { toast } from '@/lib/onlook/ui/sonner';
import { Textarea } from '@/lib/onlook/ui/textarea';
import { cn } from '@/lib/onlook/ui/utils';
import { observer } from 'mobx-react-lite';
import { useRef, useState, type SetStateAction } from 'react';

// Stub i18n: passthrough until next-intl is wired into Build-Factory
    ...
    editor: {
        panels: {
            edit: {
                tabs: {
                    chat: {
                        miniChat: { button: 'Chat' },
                        input: { placeholder: 'Ask AI to edit...' },
                    },
                },
            },
        },
