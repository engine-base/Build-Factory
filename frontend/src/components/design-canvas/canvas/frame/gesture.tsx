...
import type { FrameData } from '@/components/design-canvas/store/frames';
import { getRelativeMousePositionToFrameView } from '@/components/design-canvas/store/overlay/utils';
import type { DomElement, ElementPosition, Frame } from '@/lib/onlook/models';
import { EditorMode, InsertMode, MouseAction } from '@/lib/onlook/models';
