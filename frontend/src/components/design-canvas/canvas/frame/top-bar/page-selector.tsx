...
import { LeftPanelTabValue, type Frame, type PageNode } from '@/lib/onlook/models';
...
import {
    ...
    DropdownMenuItem,
    DropdownMenuTrigger,
} from '@/lib/onlook/ui/dropdown-menu';
import { Icons } from '@/lib/onlook/ui/icons';
import { Separator } from '@/lib/onlook/ui/separator';
import { cn } from '@/lib/onlook/ui/utils';
import { inferPageFromUrl, pathsEqual } from '@/lib/onlook/utility';
