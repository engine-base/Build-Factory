// TODO: Build-Factory integration - removed Onlook dependency (@onlook/fonts)
// Minimal subset of font defaults used by this utility.
const DEFAULT = { STYLE: 'normal', WEIGHT: '400' } as const;
interface FontVariant { name: string; value: string }
