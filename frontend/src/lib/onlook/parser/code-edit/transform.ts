import type { CodeAction } from '@/lib/onlook/models/actions';
import type { CodeDiffRequest } from '@/lib/onlook/models/code';
import { CodeActionType } from '@/lib/onlook/models/actions';
import { assertNever } from '@/lib/onlook/utility';
