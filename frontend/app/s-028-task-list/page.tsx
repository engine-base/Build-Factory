/**
 * T-V3-C-58 / S-028 — Ticket-mandated path alias for the task_list Next.js
 * page. The canonical route is mounted at
 * `frontend/src/app/(app)/task/list/page.tsx` because the Build-Factory
...
export { default } from "../../src/app/(app)/task/list/page";
