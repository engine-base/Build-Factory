 ...
 * `frontend/src/app/forbidden/page.tsx` because the Build-Factory Next.js 15
 * project uses the `src/app/` App-Router root (see `frontend/next.config.ts`,
...
export { default } from "../../src/app/forbidden/page";
