/**
 * T-V3-C-59 / S-029 — Ticket-mandated path alias for the task_dag_view
 * Next.js page. The canonical route is mounted at
 * `frontend/src/app/(app)/task/dag/page.tsx` because the Build-Factory
 * Next.js 16 project uses the `src/app/` App-Router root (see
...
export { default } from "../../src/app/(app)/task/dag/page";
