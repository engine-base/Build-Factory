/**
 * T-V3-C-63 / S-014 — Ticket-mandated path alias for the workspace_members
 * Next.js page. The canonical route is mounted at
 * `frontend/src/app/(app)/workspace/[id]/members/page.tsx` because the
...
export { default } from "../../src/app/(app)/workspace/[id]/members/page";
