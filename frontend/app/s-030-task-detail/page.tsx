/**
 * T-V3-C-60 / S-030 — Ticket-mandated path alias for the task_detail Next.js
 * page. The canonical route is mounted at
 * `frontend/src/app/(app)/task/[id]/page.tsx` because the Build-Factory
...
export { default } from "../../src/app/(app)/task/[id]/page";
