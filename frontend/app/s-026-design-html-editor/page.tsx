/**
 * T-V3-C-52 / S-026 — Ticket-mandated path alias for the design_html_editor
 * Next.js page. The canonical route is mounted at
 * `frontend/src/app/(app)/spec/html-editor/page.tsx` because the Build-Factory
 ...
 * because `src/app/` shadows `app/` when both are present (same convention as
 * the T-V3-C-49 / T-V3-C-51 path-alias shims).
 *
 * Re-exports the default page so tooling that imports from this path resolves
 * the same component as the live route.
 */

export { default } from "../../src/app/(app)/spec/html-editor/page";
